...
public class InputGenPanel extends JPanel implements Generator
{
     ...
     */
    public InputGenPanel(Client client)
    {
        super();
    ...
    {
        File file = SwingPanel.showFileDialog(m_client, "Load Query/Distribution");
    ...
    {
        File file = SwingPanel.showFileDialog(m_client, "Save Distribution File");
    ...
    {
        File newFile = SwingPanel.showFileDialog(m_client, "Save Tupples");
    ...
    {
        File file = SwingPanel.showFileDialog(m_client, "Load Tuple File");
