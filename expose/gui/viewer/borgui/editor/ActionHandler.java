...
public class ActionHandler {
    ...
    public static final int RUN_SIMULATION_ACTION  = 17;
    public static final int STOP_SIMULATION_ACTION  = 18;

    
    // total number of actions
    protected static final int TOTAL_ACTIONS = 19;
    ...
    public ActionHandler(EditorPanel editor) {
        ...
        m_actions[RUN_SIMULATION_ACTION] = new RunSimulationAction();
        m_actions[STOP_SIMULATION_ACTION] = new StopSimulationAction();
    ...
    public ActionHandler(AnalysisPanel analysisPanel) {

        m_analysisPanel = analysisPanel;
    ...
    protected class RunSimulationAction extends AbstractAction {
        public RunSimulationAction() {
        }

        public void actionPerformed(ActionEvent e) {
            m_editorPanel.runSimulations();
        }
    }

    protected class StopSimulationAction extends AbstractAction {
        public StopSimulationAction() {
        }

        public void actionPerformed(ActionEvent e) {
            m_editorPanel.stopSimulation();
        }
    }
