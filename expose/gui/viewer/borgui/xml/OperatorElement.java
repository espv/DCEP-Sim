 ...
 */
public class OperatorElement  extends BoxElement
        implements HasQueryElement, HasNodeElement
{

    public static final String NAME = XmlConstants.OPERATOR_ELEMENT;


    public OperatorElement(String name, String type)
    {
        super(name, type);
    }
    ...
    public OperatorElement(Element element)
    {
        super(element);
    }
    ...
    public void addInput(OperatorElement inputOperator) {

    }

    public void addOutput(OperatorElement outputOperator) {
    ...
    {
        return this.getChildren(XmlConstants.ATTRIBUTE_ELEMENT);
    }
    ...
    public boolean addAttribute(AttributeElement attr)
    {
        this.addContent(attr);
        return true;
    }
