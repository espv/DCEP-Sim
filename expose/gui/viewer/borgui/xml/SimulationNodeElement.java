 ...
 */
public class SimulationNodeElement extends BorealisElement
{
    public static final String NAME = XmlConstants.SIMNODE_ELEMENT;
    int nodeId;


    public SimulationNodeElement()
    {
        super(NAME);
    ...
    public SimulationNodeElement(String name)
    {
        super(NAME);
        this.setNameValue(name);
        this.addContent(new ParameterElement("Cpu cores", "1"));
        this.addContent(new ParameterElement("Cpu frequency", "1GHz"));
        this.addContent(new ParameterElement("RAM", "1GB"));
        this.addContent(new ParameterElement("Availability", "1"));
    }

    public SimulationNodeElement(String name, int nodeId)
    {
        super(NAME);
        this.setNameValue(name);
        this.nodeId = nodeId;
    ...
    public SimulationNodeElement(Element element)
    {
        super(NAME, element);
    }
