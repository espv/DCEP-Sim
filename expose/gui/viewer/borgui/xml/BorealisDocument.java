...
public class BorealisDocument extends Document
{
    ...
    {
        this.getNetwork().setNetworkParameters(networkParameterElement);
    }

    public NetworkParameterElement getNetworkParameters()
    {
        return this.getNetwork().getNetworkParameters();
    }
    ...
    {
        return this.getNetwork().addSimulationNode(simulationNode);
    }


    public boolean addDataset(DatasetElement datasetElement)
    {
        return this.getNetwork().addDataset(datasetElement);
    }
    ...
    {
        return this.getNetwork().getAllDatasets();
    }


    public List<ExperimentElement> getAllExperiments()
    {
        return this.getNetwork().getAllExperiments();
    }

    public List<PlotElement> getAllPlots()
    {
        return this.getNetwork().getAllPlots();
    }
    ...
    {
        return this.getNetwork().addExperimentTask(taskSetElement);
    }

    public boolean removeExperiment(ExperimentElement experimentElement)
    {
        return this.getNetwork().removeExperiment(experimentElement);
    }

    public boolean addExperiment(ExperimentElement experimentElement)
    {
        return this.getNetwork().addExperiment(experimentElement);
    }

    public boolean addPlot(PlotElement plotElement)
    {
        return this.getNetwork().addPlot(plotElement);
    }
    ...
    public boolean setExperiment(ExperimentElement experimentElement)
    {
        return true;
    }
