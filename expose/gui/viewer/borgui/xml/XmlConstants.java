...
public interface XmlConstants
{
    ...
    public final static String NETWORKPARAMETER_ELEMENT   = new String("network");
    ...
    public final static String ATTRIBUTE_ELEMENT    = new String("attribute");
    public final static String ACCESS_ELEMENT       = new String("access");

    public final static String QUERY_ELEMENT        = new String("query");
    public final static String OPERATOR_ELEMENT        = new String("operator");

    public final static String SIMNODE_ELEMENT        = new String("simulation_node");
    public final static String DATASET_ELEMENT        = new String("dataset");
    public final static String EXPERIMENT_ELEMENT        = new String("experiment");
    public final static String PLOT_ELEMENT        = new String("plot");
    public final static String EXPERIMENTTASK_ELEMENT        = new String("task");
    public final static String FLOWTASK_ELEMENT        = new String("flow");
    ...
    public final static String STREAM_ATTRIBUTE     = new String("stream");
    ...
    public final static String ID_ATTRIBUTE = new String("id");
    ...
    public final static String FIELD_VALUETYPE_ATTRIBUTE = new String("value-type");
