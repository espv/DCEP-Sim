      ...
      switch (m_reassemblingState)
        {
          case WAITING_S0_FULL:
                  switch (framingInfo)
                    {
                      case ((int) LteRlcAmHeader::FIRST_BYTE | (int) LteRlcAmHeader::LAST_BYTE):
                              m_reassemblingState = WAITING_S0_FULL;
                      ...
                      case ((int) LteRlcAmHeader::FIRST_BYTE | (int) LteRlcAmHeader::NO_LAST_BYTE):
                      ...
                      case ((int) LteRlcAmHeader::NO_FIRST_BYTE | (int) LteRlcAmHeader::LAST_BYTE):
                      case ((int) LteRlcAmHeader::NO_FIRST_BYTE | (int) LteRlcAmHeader::NO_LAST_BYTE):
                      default:
                              /**
