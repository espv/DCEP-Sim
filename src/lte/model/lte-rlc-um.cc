      ...
      switch (m_reassemblingState)
        {
          case WAITING_S0_FULL:
                  switch (framingInfo)
                    {
                      case ((int) LteRlcHeader::FIRST_BYTE | (int) LteRlcHeader::LAST_BYTE):
                              m_reassemblingState = WAITING_S0_FULL;
                      ...
                      case ((int) LteRlcHeader::FIRST_BYTE | (int) LteRlcHeader::NO_LAST_BYTE):
                      ...
                      case ((int) LteRlcHeader::NO_FIRST_BYTE | (int) LteRlcHeader::LAST_BYTE):
                              m_reassemblingState = WAITING_S0_FULL;
                      ...
                      case ((int) LteRlcHeader::NO_FIRST_BYTE | (int) LteRlcHeader::NO_LAST_BYTE):
