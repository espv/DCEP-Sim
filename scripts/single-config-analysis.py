...
migration_modes_aggregation = ["no-migration", "all-at-once", "lazy", "meces", "megaphone"]
migration_modes_join_aggregation = ["no-migration", "all-at-once", "lazy", "meces", "megaphone"]
...
yaml_files = ['join-test.yaml', 'aggregation-test.yaml', 'join-and-aggregation-test.yaml', 'join-and-aggregation-test.yaml', 'join-and-aggregation-max-utility-test.yaml']
...
query, migration_modes, x_param, x_values, yaml_file = queries[index], configs[index], x_params[index], x_values[index], yaml_files[index]
...
plt.legend()
plt.savefig(f"{results_path}/latency_{query.replace(' ', '_')}_{index}.png")
...
plt.legend()
plt.savefig(f"{results_path}/deviation_{query.replace(' ', '_')}_{index}.png")
